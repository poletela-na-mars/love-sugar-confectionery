...
export const CartItem = ({ id, title, price, imageUrl, types, count, enableAnimations }: CartItemProps) => {
  ...
  return (
      <>
        {
            isPopupOpen &&
            <Popup confirmActionClickHandler={onRemoveConfirmButtonClickHandler} setIsPopupOpen={setIsPopupOpen}
                   isPopupOpen={isPopupOpen} confirmText='Да' cancelText='Нет'
                   text={<p>Вы действительно хотите <span>удалить</span> товар?</p>} />
        }
        ...
        <div className='cart__item'>
          ...
          <div className='cart__item-block'>
            ...
            <div className='cart__item-count'>
              ...
              <b>{count}</b>
              <button onClick={onPlusClickHandler}
