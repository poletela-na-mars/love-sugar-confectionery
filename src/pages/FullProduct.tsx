...
export const FullProduct = () => {
  ...
  // TODO - ?description, composition (состав), style 'add to cart' buttons
  return (
        ...
        }
        {
          !product
              ...
              : <div className='full-product-block'>
                ...
                <div className='pizza-block__bottom full-product__bottom'>
                  <div className='pizza-block__price full-product__price'>{product.price[activeType as number]} ₽</div>
