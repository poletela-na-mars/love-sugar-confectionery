...
import { CartEmpty, CartItem, Popup } from '../components';
...
const Cart = () => {
  ...
  const onClearConfirmButtonClickHandler = () => {
    dispatch(
        clearItems()
    );
  };
  ...
  return (
      <>
        {
            isPopupOpen &&
            <Popup confirmActionClickHandler={onClearConfirmButtonClickHandler} setIsPopupOpen={setIsPopupOpen}
                   isPopupOpen={isPopupOpen} confirmText='Да' cancelText='Нет'
        ...
        <div className='container container--cart'>
          <div className='cart'>
            <div className='cart__top'>
              ...
              <button onClick={onClearClickHandler} className='cart__clear'>
